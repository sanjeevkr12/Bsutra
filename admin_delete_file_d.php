          ...
          <tr>
            <td width="100%" align="left" valign="top"><table width="100%" border="0" align="left" cellpadding="0" cellspacing="0">
              ...
              <tr>
                ...
                <td width="100%" background="images/top_mid.jpg" class="menu">Delete Files from Downloads <input name="button" type="button" class="black_text" 
onClick="javascript: history.go(-1)" value="Back to Dashboard"></td>
              ...
              <tr>
               ...
               <table width="150" border="0" cellspacing="5" cellpadding="5">
                  <tr>
                    <td valign="top"><form  action="admin_delete_file_2_d.php?id=<? echo $val; ?>"  method="post">
