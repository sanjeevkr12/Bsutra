...
<table width="100%" border="0" align="left" cellpadding="0" cellspacing="0" id="Table_01"><!--DWLayoutTable-->
	...
	$lval=	$_POST["youtube_link"];		
					...
					if($tval=='v')
					 $tval="Video";
$sql="insert into z_uploads (name,link,type,institute,uploaded_by,ip_addr,filen,filetyp,filesz,status) values ('$nval','$lval','$tval','$ival','$user','$ip','YouTube Video/FLV','Youtube Video','Online Video','1');";
...
while( ($lval[$i] != "&") && ($lval[$i] != ""))
{
  ...
  echo ("<p class=\"text_green\">Video has been succesfully posted.</p>");
  echo ("<p>Click <a href=\"admin_dashboard.php\"><span class=\"blue_text_small\">here</span></a> to return to the dashboard.</p>");
  echo ("<p>
