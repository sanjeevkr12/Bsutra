...
if (($_FILES["file"]["size"] < 10000000)) //10mb max size
  ...
  <tr>
    ...
    if (file_exists("uploads/" . $_FILES["file"]["name"]))
	  ...
	  ?>
 <table width="80%" border="0" cellspacing="0" cellpadding="5">
 <form action="admin_text_upload.php" method="post"
...
$sql="insert into z_uploads (name,link,type,institute,uploaded_by,ip_addr,filen,filetyp,filesz,status)
...
if (!mysql_query($sql,$con))
  ...
  echo ("<p class=\"text_green\">File has been succesfully posted.</p>");
