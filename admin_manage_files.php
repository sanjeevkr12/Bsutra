...
<table width="100%" border="0" align="left" cellpadding="0" cellspacing="0" id="Table_01"><!--DWLayoutTable-->
	...
	<tr>
          ...
          <tr>
            <td width="100%" align="left" valign="top"><table width="100%" border="0" align="left" cellpadding="0" cellspacing="0">
              ...
              <tr>
                ...
                <td width="100%" background="images/top_mid.jpg" class="menu">Campus Life
		...
		<th align=\"center\" >Delete/Unapprove
						...
						include("db.php");						
						$query = "select id,name,link,type,institute,filesz,status from z_uploads order by id DESC";
...
{							
		...
		<td><a href=\"view_details.php?id=$row[0]\"><span class=\"blue_text_small\">View Details</span></a>
		</td>
		<td><span class=\"text_green\">Approved</span>
		</td>
		<td><a  href=\"admin_delete_file.php?id=$row[0]\"><span class=\"warning_red\">Delete File</span></a>
		</td>
 		</tr>";
 	    }
	else
	{
		...
		<td><a  href=\"view_details.php?id=$row[0]\"><span class=\"blue_text_small\">Play Video</span></a>
		</td>
		<td><span class=\"text_green\">Approved</span>
		</td>
		<td><a  href=\"admin_delete_file.php?id=$row[0]\"><span class=\"warning_red\">Delete Video</span></a>
		</td>
 		</tr>";
	}	
...
else
{
		...
		<td><a href=\"admin_approve_file.php?id=$row[0]\"><span class=\"black_text\">Approve ?</span></a>
		</td>
		<td><a  href=\"admin_delete_file.php?id=$row[0]\"><span class=\"warning_red\">Delete File</span></a>
		</td>
 		</tr>";
