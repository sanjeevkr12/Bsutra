                ...
                <td valign="top" background="images/mid_mid.jpg" class="black_text"><form name="formaa" onSubmit="return validate_form(this);" method="post" action="register2.php">
                  ...
                  <table width="80%" border="0" cellspacing="0" cellpadding="5">
                    ...
                    <tr class="black_text_big">
                      <td height="22" colspan="2" valign="top" class="black_text">Details marked with a <span class="warning style1">*</span> are mandatory.</td>
                      </tr>
                    
                    <tr class="black_text">
                      <td height="22" valign="top">Name<span class="warning style1">*</span></td>
                      <td><input name="name" type="text"  class="black_text" id="name" size="25" maxlength="255"></td>
                    </tr>
                    
                    <tr class="black_text">
                      <td height="22" valign="top">Email(Username)<span class="warning style1">*</span></td>
                      <td><input name="email" type="text"  class="black_text" id="email" size="25" maxlength="255"></td>
                    </tr>
                    
                    <tr class="black_text">
                      <td height="22" valign="top">Password<span class="warning style1">*</span></td>
                      <td><input name="password3" type="password" class="black_text" id="password3" size="25" maxlength="255"></td>
                    </tr>
                    
                    <tr class="black_text">
                      <td height="22" valign="top">Retype Password<span class="warning style1">*</span></td>
