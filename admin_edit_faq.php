          ...
          <tr>
            <td width="100%" align="left" valign="top"><table width="100%" border="0" align="left" cellpadding="0" cellspacing="0">
              ...
              <tr>
                ...
                <td width="100%" background="images/top_mid.jpg" class="menu">List of FAQs | <span class="black_text">
              ...
              <tr>
                ...
                <td valign="top" background="images/mid_mid.jpg" class="black_text">
				  ...
				  <p>
				    <?
					include("db.php");
					$query = "select id,ques from z_faq order by id";
					$dbresult = mysql_query($query);
					echo "<ul>";
					while($row=mysql_fetch_row($dbresult))
					{
						echo "<li><a href=\"admin_edit_faq1.php?s=$row[0]\">$row[1]</a> - <a href=\"admin_delete_faq.php?s=$row[0]\"><strong>DELETE THIS FAQ</strong></a></li><br>";
					}
					echo "</ul>";
				?>
			      </p>				  </td>
