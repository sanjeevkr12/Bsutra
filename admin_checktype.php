...
<table width="100%" border="0" align="left" cellpadding="0" cellspacing="0" id="Table_01"><!--DWLayoutTable-->
	...
	<tr>
     ...
     if($tval=='v')
	  { ?>
      <form name="form111" method="post" action="admin_video_success.php">
	  					
                        <tr class="black_text">
                      <td height="22" colspan="2" >
                      <p>Enter the YouTube link for the video that you wish to upload in the Campus Life section.</p>
