          ...
          <tr>
            <td width="100%" align="left" valign="top"><table width="100%" border="0" align="left" cellpadding="0" cellspacing="0">
              ...
              <tr>
                ...
                <td width="100%" background="images/top_mid.jpg" class="menu">Campus Life</td>
...
{							
		...
		<td><a  href=\"$row[2]\"><span class=\"blue_text_small\">Download File</span></a>
		</td>
 		</tr>";
 	    }
	else
	...
	echo "</table>";
		?>
            ...
            <td width="305" align="left" valign="top"><?php 
			include("sidebar.php");
		?></td>
          </tr>
          <tr>
