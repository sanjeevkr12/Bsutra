...
?><html>
<head>
<title>BSutra | Let the reliable authority solve your query</title>
          ...
          <tr>
            <td width="100%" align="left" valign="top"><table width="100%" border="0" align="left" cellpadding="0" cellspacing="0">
              ...
              <tr>
                ...
                <td width="100%" background="images/top_mid.jpg" class="menu">List of Bschools | <span class="black_text">
              ...
              <tr>
                ...
                <td valign="top" background="images/mid_mid.jpg" class="black_text">
				  ...
				  <p>
					...
					{
						echo "<li><a href=\"admin_edit_school1.php?s=$row[0]&n=$row[1]\">$row[1]</a></li>";
					}
					echo "</ul>";
				?>
			      </p>				  </td>
