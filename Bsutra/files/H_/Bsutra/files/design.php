...
<table width="100%" border="0" align="left" cellpadding="0" cellspacing="0" id="Table_01"><!--DWLayoutTable-->
	...
	<tr>
		<td width="100%" height="194" background="images/design_05.jpg">
			<img src="images/design_06.jpg" width="974" height="194" alt=""></td>
	</tr>
	<tr>
          ...
          <tr>
            <td width="100%" align="left" valign="top"><table width="100%" border="0" align="left" cellpadding="0" cellspacing="0">
              ...
              <tr>
                ...
                <td width="100%" background="images/top_mid.jpg" class="menu">Subheading 1 </td>
              ...
              <tr>
                ...
                <td background="images/mid_mid.jpg" class="black_text"><p>Put all the sidebar content in here ... I think It'll be easy to put everything in here. </p>
                    <p>&nbsp;</p>
                  <p>nbnbnb''</p>
                  <p>nnbnb<br>
                  </p>
