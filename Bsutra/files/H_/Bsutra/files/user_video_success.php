...
<table width="100%" border="0" align="left" cellpadding="0" cellspacing="0" id="Table_01"><!--DWLayoutTable-->
	...
	$lval=	$_POST["youtube_link"];		
					...
					if($tval=='v')
					 $tval="Video";
$sql="insert into z_uploads (name,link,type,institute,uploaded_by,ip_addr,filen,filetyp,filesz) values ('$nval','$lval','$tval','$ival','$user','$ip','YouTube Video/FLV','Youtube Video','Online Video');";
...
while( ($lval[$i] != "&") && ($lval[$i] != ""))
{
  ...
  echo ("<p class=\"warning_red\">The video has been sent to the administrator for approval. Once approved it will show up in the campus life section.</p>");
