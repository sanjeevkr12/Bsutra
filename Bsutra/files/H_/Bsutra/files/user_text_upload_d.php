...
$sql="insert into z_downloads (name,link,type,category,uploaded_by,ip_addr,filen,filetyp,filesz)
...
if (!mysql_query($sql,$con))
  ...
  echo ("<p class=\"warning_red\">File has been sent to the administrator for approval. Once approved it will show up in the downloads section.</p>");
