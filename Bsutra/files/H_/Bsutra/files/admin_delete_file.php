          ...
          <tr>
            <td width="100%" align="left" valign="top"><table width="100%" border="0" align="left" cellpadding="0" cellspacing="0">
              ...
              <tr>
                ...
                <td width="100%" background="images/top_mid.jpg" class="menu">Delete Files from Campus Life <input name="button" type="button" class="black_text" 
onClick="javascript: history.go(-1)" value="Back to Dashboard"></td>
              ...
              <tr>
               ...
               <table width="150" border="0" cellspacing="5" cellpadding="5">
                  <tr>
                    <td valign="top"><form  action="admin_delete_file_2.php?id=<? echo $val; ?>"  method="post">
...
onClick="javascript: history.go(-1)" value="No"></td>
        ...
        <?
						...
						include("db.php");	
						$vals=$_GET['id'];					
						$query = "select * from z_uploads where id='$vals'";
		...
		echo "<tr><td bgcolor=\"#587681\" class=\"warning\"><strong>Name</strong></td>
 	    ...
 	    echo "<tr><td bgcolor=\"#587681\" class=\"warning\"><strong>Type</strong></td>
				<td>:</td>
				<td>$row[3]</td></tr>";
		echo "<tr><td bgcolor=\"#587681\" class=\"warning\"><strong>Institute</strong></td>
				<td>:</td>
				<td>$row[4]</td></tr>";
