          ...
          <tr>
            <td width="100%" align="left" valign="top"><table width="100%" border="0" align="left" cellpadding="0" cellspacing="0">
              ...
              <tr>
                ...
                <td width="100%" background="images/top_mid.jpg" class="menu">Add a BSchool Profile | <span class="black_text">
...
onClick="javascript: history.go(-1)" value="Back to Dashboard">
              ...
              <tr>
                ...
                <td valign="top" background="images/mid_mid.jpg" class="black_text"><form name="form1" method="post" action="admin_add_school1.php">
                  <p>&nbsp;</p>
                  <table width="80%" border="0" cellspacing="0" cellpadding="5">
                    <!--DWLayoutTable-->
                    <tr class="black_text_big">
                      <td height="22" colspan="2" valign="top"><strong>Before adding details here, start a thread in <a href="/forum">BSUTRA FORUM</a>. </strong></td>
                      </tr>
                    <tr class="black_text">
                    ...
                    <tr class="black_text">
                      <td height="22" valign="top"><p>Grade</p>                        </td>
                      <td><label>
                        <select name="grade" class="black_text" id="grade">
                    ...
                    <tr class="black_text">
                      ...
                      <td><textarea name="other" cols="39" rows="3" class="black_text" id="other"></textarea></td>
                    </tr>
                    <tr class="black_text">
                      <td height="22" valign="top">BSUTRA FORUM LINK </td>
                      <td><p>
                        <input name="forum" type="text" class="black_text" id="forum" size="40" maxlength="255"> 
                        <br>
                        (Copy the link of the thread you made before adding details here 
                        )<br>
                      (including http:// is compulsary) </p>                        </td>
                    </tr>
                    <tr class="black_text">
