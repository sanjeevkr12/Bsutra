<?php
 session_start();
  ...
  {
  		echo "Session Expired. You need to login to view this page.";
		echo "<br>Click here to go to <a href=\"index.php\">the home page.</a>";
		exit();
  }  
          ...
          <tr>
            <td width="100%" align="left" valign="top"><table width="100%" border="0" align="left" cellpadding="0" cellspacing="0">
              ...
              <tr>
                ...
                <td width="100%" background="images/top_mid.jpg" class="menu">Downloads - File Details 
...
onClick="javascript: history.go(-1)" value="Back"></td>
		...
		echo "<tr><td bgcolor=\"#587681\" class=\"warning\"><strong>Download</strong></td>
				<td>:</td>
				<td><a href=\"$row[2]\"><span class=\"blue_text_small\">$row[2]</span></a></td>";										
		}
	else
	{
	echo "<tr><td bgcolor=\"#587681\" class=\"warning\"><strong>Name</strong></td>
