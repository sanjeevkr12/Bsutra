...
$sql="insert into z_downloads (name,link,type,category,uploaded_by,ip_addr,filen,filetyp,filesz,status) values ('$nval','$lval','$tval','$ival','$user','$ip','YouTube Video/FLV','Youtube Video','Online Video','1');";
...
while( ($lval[$i] != "&") && ($lval[$i] != ""))
{
  ...
  echo ("<p class=\"warning_red\">The video has been approved automatically. It has started to show up in the downloads section.</p>");
