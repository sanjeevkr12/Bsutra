          ...
          <tr>
            <td width="100%" align="left" valign="top"><table width="100%" border="0" align="left" cellpadding="0" cellspacing="0">
              ...
              <tr>
                ...
                <td width="100%" background="images/top_mid.jpg" class="menu">Add a FAQ Question | <span class="black_text">
...
onClick="javascript: history.go(-1)" value="Back to Dashboard">
              ...
              <tr>
                ...
                <td valign="top" background="images/mid_mid.jpg" class="black_text"><form name="form1" method="post" action="admin_add_faq1.php">
                  <p>&nbsp;</p>
                  <table width="90%" border="0" cellpadding="5" cellspacing="0" class="black_text">
                    <tr>
                      <td width="17%" valign="top">Question</td>
                      <td width="83%"><textarea name="ques" cols="40" rows="2" class="black_text" id="ques"></textarea></td>
                    </tr>
                    <tr>
                      <td valign="top">Answer</td>
                      <td><textarea name="ans" cols="40" rows="8" class="black_text" id="ans"></textarea></td>
                    </tr>
                    <tr>
                      <td colspan="2" valign="top"><label>
                        <input name="Submit" type="submit" class="black_text" value="Add this in FAQ">
                      </label></td>
                      </tr>
                  </table>
                  <p>&nbsp;</p>
