          ...
          <tr>
            <td width="100%" align="left" valign="top"><table width="100%" border="0" align="left" cellpadding="0" cellspacing="0">
              ...
              <tr>
                ...
                <td width="100%" background="images/top_mid.jpg" class="menu">Step 2 : Uploading to Campus Life </td>
...
if (($_FILES["file"]["size"] < 10000000)) //10mb max size
  ...
  <tr>
    ...
    if (file_exists("uploads/" . $_FILES["file"]["name"]))
	  ...
	  ?>
 <table width="80%" border="0" cellspacing="0" cellpadding="5">
 <form action="user_text_upload.php" method="post"
...
If there are more than one files to be uploaded then please make a zip file and upload it.</p><br /></td>
     ...
     <?   
	  ...
	  {
	  $link="http://www.bsutra.com/uploads/" . $_FILES["file"]["name"];
      echo "<br /><br />Here's the download link : <a href=$link><span class=\"blue_text_small\">Download ". $_FILES["file"]["name"] . "</a>";
	  			
					
$sql="insert into z_uploads (name,link,type,institute,uploaded_by,ip_addr,filen,filetyp,filesz)
VALUES ('$nval','$link','$tval','$ival','$user','$ip','$savename','$typvar','$sizevar')";
...
if (!mysql_query($sql,$con))
  ...
  echo ("<p class=\"warning_red\">File has been sent to the administrator for approval. Once approved it will show up in the campus life section.</p>");
  echo ("<p>Click <a href=\"user_dashboard.php\"><span class=\"blue_text_big\">here</span></a> to return to the dashboard.</p>");
mysql_close($con);
}
else 
{
