...
?>
						  ...
						  include("db.php");
						  $val=$_GET['id'];
						  $query = "update z_uploads set status='1' where id='$val'";
$dbresult= mysql_query($query);

if($dbresult)
	echo "<script language=\"javascript\">alert(\"File approved successfully ... Redirecting Back\");location.href=\"admin_manage_files.php\";</script>";
else
